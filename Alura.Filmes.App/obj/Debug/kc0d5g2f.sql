...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180212143721_Idioma', N'2.0.1-rtm-125');

GO

CREATE INDEX [Index_Sobrenome] ON [actor] ([last_name]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180216164405_IndiceAtorUltimoNome', N'2.0.1-rtm-125');
